...
All UI conforms to [`.impeccable.md`](.impeccable.md) — dark glassomorphism, opacity as
hierarchy, spring-loaded interactions, 44pt touch targets, and documented spacing / radius /
duration tokens.
